...
class Promo
{
     ...
     * @Groups({"admin_promo:read","admin_promo_referentiel:read","admin_promo_formateur:read","admin_promo_groupe:read","admin_promo_groupe_app:read"})
     */
    private $id;
     ...
     * @Groups({"admin_promo_formateur:read"})
     */
    private $formateurs;

    /**
     * @ORM\OneToMany(targetEntity=Groupe::class, mappedBy="promos",cascade={"persist"})
     * @Groups({"admin_promo_groupe:read","admin_promo_groupe_app:read"})
     */
    private $groupes;
